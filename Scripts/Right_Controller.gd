...
func _ready():
	...
	# Get the hand mesh
	hand_mesh = get_node("Right Hand")
	hand = get_node("Right Hand/Armature/Skeleton/Hand")
	keypoints = get_node("Right Hand/Armature/Skeleton/Keypoints")
...
func button_pressed(button_index):
	...
	if button_index == 15:
		...
		get_node("Right Hand").pose("finger_out")
	
	
	# If the grab button is pressed...
	if button_index == 2:
		get_node("Right Hand").pose("fist")
...
func button_released(button_index):
	...
	if button_index == 15:
		get_node("Right Hand").pose("finger_in")
	if button_index == 2:
		get_node("Right Hand").pose("default")
	if button_index == 1:
		keypoints.visible = false
		hand.visible = true
...
func _on_Area_body_entered(body):
	if body.name.right(8) == "1R":
		get_node("Right Hand").getData(11)
	elif body.name.right(8) == "2R":
		get_node("Right Hand").getData(10)
	elif body.name.right(8) == "3R":
		get_node("Right Hand").getData(9)
	elif body.name.right(8) == "4R":
		get_node("Right Hand").getData(8)
	elif body.name.right(8) == "5R":
		get_node("Right Hand").getData(7)
	elif body.name.right(8) == "6R":
		get_node("Right Hand").getData(6)
	elif body.name.right(8) == "7R":
		get_node("Right Hand").getData(5)
	elif body.name.right(8) == "8R":
		get_node("Right Hand").getData(4)
	elif body.name.right(8) == "9R":
		get_node("Right Hand").getData(3)
	elif body.name.right(8) == "10R":
		get_node("Right Hand").getData(2)
	elif body.name.right(8) == "11R":
		get_node("Right Hand").getData(1)
	elif body.name.right(8) == "12R":
		get_node("Right Hand").getData(0)
	elif body.name.right(8) == "13R":
		get_node("Right Hand").getData(12)
	elif body.name.right(8) == "14R":
		get_node("Right Hand").getData(13)
	elif body.name == "Reverse Button":
		get_node("Right Hand").changeDirection()


func _on_Area_body_exited(body):
	get_node("Right Hand").set_physics_process(false)
	get_node("Right Hand").findPose()
